...
/**
 * Created by prave on 04-09-2017.
 */
...
public class ProfileImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public ProfileImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ProfileImageBehavior);
            mCustomFinalYPosition = a.getDimension(R.styleable.ProfileImageBehavior_finalYPosition, 0);
            mCustomStartXPosition = a.getDimension(R.styleable.ProfileImageBehavior_startXPosition, 0);
            mCustomStartToolbarPosition = a.getDimension(R.styleable.ProfileImageBehavior_startToolbarPosition, 0);

            mCustomStartHeight = a.getDimension(R.styleable.ProfileImageBehavior_startHeight, 0);
            mCustomFinalHeight = a.getDimension(R.styleable.ProfileImageBehavior_finalHeight, 0);
